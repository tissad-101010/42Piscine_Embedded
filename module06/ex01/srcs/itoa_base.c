...
/*   Updated: 2025/03/14 14:34:36 by tissad           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void itoa_base_rec(uint32_t value, char *buffer, char *base, int base_len, int *i)
{
	if (value == 0)
		return;
...
void itoa_base(int32_t value, char *buffer, char *base)
{
	...
	if (value < 0)
	{
		...
		uvalue = value;
	itoa_base_rec(uvalue, buffer, base, base_len, &i);
	buffer[i] = '\0';
}
